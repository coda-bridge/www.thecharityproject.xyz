const transData = {
    ...
    "Log in": "登入",
    "Register": "註冊",
    "Log-in or register to claim fund(s) you are eligible for.": "請登入以領取您符合資格的基金",
    "Help Center": "支援中心",
    ...
    "seconds": "秒",
    "second": "秒",
    "Sorry, there is a problem with your login attempt.": "對不起，您的登錄嘗試有問題。",
    "Sorry, there is a problem with your registration.": "對不起，您的註冊嘗試有問題。",
    "Before you create an account, please make sure your phone number is correct.": "在您創建帳戶之前，請確保您的電話號碼正確。",
    "Welcome": "歡迎",
    ...
    "Scan QR Code to pay": "掃描QR碼以支付",
    "Redeem voucher": "兌換優惠券",
    "Scan QR Code": "掃描QR碼",
    "If unsuccessful, you can use": "如果失敗，您可以使用",
    "non-camera mode": "非攝像頭模式",
    "You are redeeming your voucher(s) at the following outlet and amount:": "您正在兌換您的優惠券，商家和金額如下：",
    "Your balance": "您的餘額",
    ...
    "A one-time code has been sent to your phone number. Simply enter the code to complete your voucher redemption.": "一次性代碼已發送到您的手機號碼，請輸入該代碼以完成優惠券兌換。",
    ...
    "Amount:": "金額：",
    "When:": "時間：",
    "Check out the transaction history": "查看交易歷史",
    "Distributed:": "發放：",
    "Redeemed:": "已兌換：",
    "Getting data": "獲取數據中",
    "Last updated": "最後更新",
    ...
    "Input the amount you want to receive": "輸入您想要收到的金額",
    "Download the QR code": "下載 QR 碼",
    "Voucher(s) received today": "今日收到的優惠券",
    "More": "更多",
    "Balance:": "餘額：",
    "Notes:": "備註：",
    "To be used only for vouchers for The Dignity Kitchen at its designated outlets only.": "僅用於厨尊廚房的指定店鋪的優惠券。",
    "Please upload a CSV file contains client's phone number and amount of the voucher.": "請上傳包含客戶電話號碼和優惠券金額的 CSV 文件。",
    "See a sample here": "在此處查看示例",
    "You can only upload one file each time.": "每次只能上傳一個文件。",
    "It may take several minutes to refill the vouchers.": "補充優惠券可能需要幾分鐘的時間。",
    "The transaction will continue even if the account doesn't exist. Once the client registers an account, he/she will get the voucher at the same time.": "即使帳戶不存在，交易也將繼續進行。 客戶註冊帳戶後，將同時獲得優惠券。",
    ...
    "In process": "處理中",
    "Back to home": "返回首頁",
    "Save the refill records": "保存補充紀錄",
    "Confirm": "確認",
    "Ronald McDonald's House Voucher Terms of Use": "麥當勞叔叔之家消費券使用條款",
    "I have read and agree to the": "我已閱讀並同意",
    "Terms of Use": "使用條款",
    "terms of use:": "使用條款：",
    "This coupon can only be used in Hong Kong. All coupons are expressed in Hong Kong dollars and must be registered in our system before they can be used at designated locations of Dignity Kitchen HK by scanning the dedicated QR code.": "本消費券僅限於香港地區使用。所有消費券均以港幣表示，必須在我們的系統中註冊後，方可在厨尊厨房指定地點通過掃描專用的QR碼使用。",
    ...
    "I understand": "我了解",
    "Sorry, there is a problem with your registration.(error type:": "對不起，您的註冊過程中出現問題。（錯誤類型：",
    "Sorry, there is a problem with your login attempt.(error type:": "對不起，您的登錄嘗試出現問題。（錯誤類型：",
    ...
    "Failed to send CMT for gas fee.": "未能为矿工手续费发送 CMT。",
    "Failed to approve ERC20 for funding.": "未能批准 ERC20 供資金。",
    "Failed to fund user.": "無法為用戶提供資金。",
    "Failed to update database.": "無法更新數據庫。",
    "The mode is neither phone or email.": "模式既不是电话也不是电子邮件。",
    "Cannot create session for the user": "無法為用戶創建會話",
    "Failed to send login link! Please try again later.": "發送登錄鏈接失敗！請稍後再試。",
    "The phone number is not activated. Please sign up first.": "电话号码未激活。请先注册。"
};
